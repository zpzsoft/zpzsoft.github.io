		...
		if (NewBP)
		{
			...
			if (AbilityBP == NULL)
			{
				...
				if (Settings && Settings->bSpawnDefaultBlueprintNodes)
				{
					...
					FKismetEditorUtilities::AddDefaultEventNode(NewBP, NewGraph, FName(TEXT("OnAbilityStart")), UAblAbility::StaticClass(), NodePositionY);
					FKismetEditorUtilities::AddDefaultEventNode(NewBP, NewGraph, FName(TEXT("OnAbilityEnd")), UAblAbility::StaticClass(), NodePositionY);
					FKismetEditorUtilities::AddDefaultEventNode(NewBP, NewGraph, FName(TEXT("OnAbilityInterrupt")), UAblAbility::StaticClass(), NodePositionY);
					FKismetEditorUtilities::AddDefaultEventNode(NewBP, NewGraph, FName(TEXT("OnAbilityBranch")), UAblAbility::StaticClass(), NodePositionY);
				}
			}
		}
